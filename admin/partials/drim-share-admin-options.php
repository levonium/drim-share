...
class Drim_Share_Options {
    ...
    public function drim_share_options_page_init() {
      ...
      add_settings_section(
				...
				__( $drim_share_settings_main_section[1], 'drim-share' ), // Title
      ...
      foreach( $drim_share_settings_main as $settings_field_main ) {
        ...
        add_settings_field(
  				...
  				__( $settings_field_main[1], 'drim-share' ), // Title
      ...
      add_settings_section(
				...
				__( $drim_share_settings_position_section[1], 'drim-share' ), // Title
      ...
      foreach( $drim_share_settings_position as $settings_field_position ) {
        ...
        add_settings_field(
  				...
  				__( $settings_field_position[1], 'drim-share' ), // Title
      ...
      add_settings_section(
        ...
        __( $drim_share_settings_mobile_section[1], 'drim-share' ), // Title
      ...
      foreach( $drim_share_settings_mobile as $settings_field_mobile ) {
        ...
        add_settings_field(
  				...
  				__( $settings_field_mobile[1], 'drim-share' ), // Title
      ...
      add_settings_section(
        ...
        __( $drim_share_settings_post_types_section[1], 'drim-share' ), // Title
      ...
      foreach( $drim_share_settings_post_types as $settings_field_post_types) {
        ...
        add_settings_field(
  				...
  				__( $settings_field_post_types[1], 'drim-share' ), // Title
      ...
      add_settings_section(
				...
				__( $drim_share_settings_optional_section[1], 'drim-share' ), // Title
      ...
      foreach( $drim_share_settings_optional as $settings_field_optional ) {
        ...
        add_settings_field(
  				...
  				__( $settings_field_optional[1], 'drim-share' ), // Title
    ...
    function ds_networks_callback() {
      ...
      foreach( $ds_networks as $ds_network => $ds_network_name) {
        ...
        $ds_check = '<p><input type="checkbox" id="ds_networks_' .  $ds_network . '" name="drim_share_settings_options[ds_networks_' . $ds_network . ']" value="1"' . checked( 1, $ds_opt, false ) . '/>
          <label for="ds_networks_' . $ds_network . '">'. __( $ds_network_name, 'drim-share' ) . '</label></p>';
      ...
      if ( $ds_post_types ) {
        foreach( $ds_post_types as $ds_post_type ) {
          ...
          $ds_check = '<p><input type="checkbox" id="ds_post_type_' .  $ds_post_type . '" name="drim_share_settings_options[ds_post_type_' . $ds_post_type . ']" value="1"' . checked( 1, $ds_opt, false ) . '/>
            <label for="ds_post_type_' . $ds_post_type . '">'. __( ucfirst($ds_post_type), 'drim-share' ) . '</label></p>';
